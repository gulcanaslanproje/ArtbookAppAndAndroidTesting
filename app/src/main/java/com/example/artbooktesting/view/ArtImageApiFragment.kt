...
import com.example.artbooktesting.databinding.ArtimagapiFragmentBinding
...
class ArtImageApiFragment @Inject constructor(
...
) : Fragment(R.layout.artimagapi_fragment) {

    lateinit var viewModel: ArtViewModel

    private var fragmentBinding: ArtimagapiFragmentBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val binding = ArtimagapiFragmentBinding.bind(view)
